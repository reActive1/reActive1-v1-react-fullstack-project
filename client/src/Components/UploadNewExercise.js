					...
					<div className="col-md-6">
						<div className="myLeftCtn">
							<form onSubmit={handleSubmitFile} className="container-upload">
								<header>
									Do it yourself! <IoIo.IoIosConstruct />
								</header>
								<input
									type="file"
									name="image"
							...
							<div className="box text-white pb-5 text-center">
								...
								{!previewSource && (
									<p className="contact-text pt-4">
										Upload a gif, select category, choose a name and thats it!
									</p>
								)}
								{previewSource && <img src={previewSource} alt="chosen" style={{ height: '250px' }} />}
							</div>
						</div>
					</div>
				</div>
