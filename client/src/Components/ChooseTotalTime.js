...
class ChooseTotalTime extends React.Component {
	...
	updateRestTime = (restTime) => {
		let tempRandomExercises = getRandomExerciseTraining(
			this.state.exercises,
			this.state.trainingtime / 60000,
			restTime
		);
		this.setState({
			restTime: restTime,
	...
	async componentDidMount() {
		try {
			const res = await axios.get(`${ENV}/api/exercises`);
									...
									<div className="TrainingTimeSelection">
										...
										<div className="container container-btn">
											<div className="bar bar-grey">
												<div className="option" onClick={() => this.updateTrainingTime(20)}>
													20
												</div>
												<div className="option" onClick={() => this.updateTrainingTime(30)}>
													30
												</div>
												<div className="option" onClick={() => this.updateTrainingTime(40)}>
													40
												</div>
											</div>
									...
									<div className="RestTimeSelection">
										...
										<div className="container container-btn">
											<div className="bar2 bar2-grey">
												<div className="option" onClick={() => this.updateRestTime(20)}>
													20
												</div>
												<div className="option" onClick={() => this.updateRestTime(30)}>
													30
												</div>
												<div className="option" onClick={() => this.updateRestTime(40)}>
													40
												</div>
											</div>
							...
							<div className="col-md-6">
								<div className="myRightCtn colorBox">
									<div className="box text-white pb-5 text-center">
										<header>Create your training</header>
												...
												<div className="Wrapper">
													<div className="ContinueLinkChooseExercises animation-box">
														<NavLink
															...
															to={{
																pathname: `/ExerciseForm/${this.state
																	.trainingtime}/${this.state.restTime}`
															}}
														>
															<span />
															<span />
													...
													<div className="ContinueLinkRandomExercises animation-box">
														<NavLink
															...
															to={{
																pathname: `/Timer/`,
																props: {
																	exercisesArray: this.state.randomExerciseImages,
